...
BEGIN
  ...
  DECLARE p_price, p_amount double(17,10);
  DECLARE p_user_id int;

  DECLARE p_coin_name_to_id, p_coin_name_from_id int; -- ID in system
  DECLARE p_price_from, p_price_to double(17,10); -- Price in World
  DECLARE p_user_coin_from, p_user_coin_to double(17,10); -- Coin in user wallet

  DECLARE p_user_coin_from_later, p_user_coin_to_later double(17,10);

  DECLARE p_coin_params_id int;
...
--  SELECT p_user_coin_to, p_user_coin_from, p_user_coin_to_later, p_user_coin_from_later, p_amount, p_price, p_amount/p_price;
